...
/*Procedure structure for Procedure `logistic_confirm_info.get` */;

DROP PROCEDURE IF EXISTS `logistic_confirm_info.get`;

DELIMITER $$
CREATE PROCEDURE `logistic_confirm_info.get`(
...
ll:BEGIN
    ...
    DECLARE v_procname       VARCHAR(100) DEFAULT 'logistic_confirm_info.get';
    ...
    SELECT a.variety,a.matchedQuantity,v_carNo,b.toLocation,b.logisticsExpense
