...
/*Event structure for Event `abnormal_queues_handle` */;

DROP EVENT IF EXISTS `abnormal_queues_handle`;

DELIMITER $$

CREATE EVENT `abnormal_queues_handle` ON SCHEDULE EVERY 1 MINUTE STARTS '2016-01-01 00:00:00' ON COMPLETION PRESERVE ENABLE DO ll:BEGIN
    DECLARE v_returnCode                 INT;
    DECLARE v_returnMsg                  LONGTEXT;
    DECLARE v_curMsg                     LONGTEXT;
    DECLARE imp_lock                     INT;
    DECLARE v_procname                   VARCHAR(50) DEFAULT 'abnormal_queues_handle.job';
    DECLARE v_modulename                 VARCHAR(50) DEFAULT 'messageManager';
    DECLARE v_body                       LONGTEXT DEFAULT NULL;
    DECLARE v_lock_name                  VARCHAR(50) DEFAULT 'abnormal_queues_handle';
